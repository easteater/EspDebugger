...
private:
   ...
   // QTimer *parseSerialPortDataTimer ;
    ...
    map<QString, QAction*> fileRightButtionAction;
    map<QString, QString> fileRightButtionActionCmd;
    QStringList menuListCaption ;
    QMenu fileRightButtonContextMenu; // 声明 contextMenu 作为一个私有成员变量
